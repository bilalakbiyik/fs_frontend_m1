...
//? toLowerCase() --> built-in fonksiyon (JS'nin içerisinde tanımlı olan fonksiyonlar)
const koşul =
...
//? if (koşul) ==> if (koşul === true)
//* if (!koşul) ==> if (koşul === false)
...
if(isNaN(s1) || isNaN(s2)) {  // null, undefined, "", false, NaN, Boolean(0) => falsy
